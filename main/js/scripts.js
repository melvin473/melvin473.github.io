...
function loadPets() {
  const pets = [
    { nome: "Bella", telefone: "1111111111", descricao: "Bella foi encontrada em uma noite fria, perdida e assustada. Sua família não pôde ser localizada, e agora ela busca um novo lar cheio de amor e carinho. (cadastro demonstrativo)", endereco: "Rua A, 123", situacao: "Para Adoção", tipo: "Cachorro", porte: "Médio", raca: "Labrador", castrado: "Sim", vacinado: "Sim" },
    { nome: "Max", telefone: "2222222222", descricao: "Max foi abandonado em um parque da cidade. Ele é brincalhão e carinhoso, mas precisa de uma nova família que lhe dê o amor que merece. (cadastro demonstrativo)", endereco: "Rua B, 456", situacao: "Para Adoção", tipo: "Gato", porte: "Pequeno", raca: "Siamês", castrado: "Sim", vacinado: "Sim" },
    { nome: "Luna", telefone: "3333333333", descricao: "Luna foi resgatada de um lar abusivo. Agora está segura e se recuperando, pronta para encontrar um lar onde possa viver em paz e ser feliz. (cadastro demonstrativo)", endereco: "Rua C, 789", situacao: "Para Adoção", tipo: "Cachorro", porte: "Grande", raca: "Pastor Alemão", castrado: "Sim", vacinado: "Sim" },
    { nome: "Charlie", telefone: "4444444444", descricao: "Charlie apareceu no quintal de uma casa, magro e com fome. Foi alimentado e cuidado, mas precisa de um lar definitivo onde receba todo o carinho que merece. (cadastro demonstrativo)", endereco: "Rua D, 101", situacao: "Para Adoção", tipo: "Gato", porte: "Médio", raca: "Persa", castrado: "Sim", vacinado: "Sim" },
    { nome: "Molly", telefone: "5555555555", descricao: "Molly foi deixada amarrada em frente a um abrigo. É cheia de energia e amor, esperando por uma família que possa acompanhá-la em suas aventuras. (cadastro demonstrativo)", endereco: "Rua E, 202", situacao: "Para Adoção", tipo: "Cachorro", porte: "Pequeno", raca: "Beagle", castrado: "Sim", vacinado: "Sim" },
      { nome: "Oliver", telefone: "6666666666", descricao: "Oliver era de um lar onde não era mais bem-vindo. Agora ele procura uma nova casa onde possa ser aceito e amado pelo que é. (cadastro demonstrativo)", endereco: "Rua F, 303", situacao: "Para Adoção", tipo: "Gato", porte: "Grande", raca: "Maine Coon", castrado: "Sim", vacinado: "Sim" },
      { nome: "Daisy", telefone: "7777777777", descricao: "Daisy foi encontrada vagando pelas ruas, sozinha e com medo. Ela é extremamente dócil e está pronta para ser parte de uma nova família. (cadastro demonstrativo)", endereco: "Rua G, 404", situacao: "Para Adoção", tipo: "Cachorro", porte: "Médio", raca: "Poodle", castrado: "Sim", vacinado: "Sim" },
      ...
      { nome: "Nala", telefone: "1010101010", descricao: "Nala foi resgatada de um mercado, onde vivia entre caixas e sacos. Ela é uma gata doce que adora atenção e precisa de um lar amoroso. (cadastro demonstrativo)", endereco: "Rua J, 707", situacao: "Para Adoção", tipo: "Gato", porte: "Médio", raca: "Bengal", castrado: "Sim", vacinado: "Sim" }
    ];
